<%-- 
    Document   : checkout
    Created on : 11-May-2023, 9:51:36 pm
    Author     : ROHIT
--%>
<%
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary checkout-btn"  onclick="goToHome()">Add Items</button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="#!">
                                ...
                                <div class="container text-center">
                                     <button type="button" class="btn btn-primary checkout-btn" style="box-sizing: border-box;" onclick="goToOrder()">Order Now</button>
                                     <button type="button" class="btn btn-primary checkout-btn" style="background-color: #dc3545;box-sizing: border-box;" onclick="goToHome()">Cancel</button>
